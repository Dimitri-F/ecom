...
<?php if (!empty($order)) : ?>
    <div class="container mx-auto p-6">
        <h1 class="text-3xl text-center font-bold mb-6">Détail de la commande #<?= htmlspecialchars($order['id']) ?></h1>

        <!-- Informations sur la commande -->
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
            <h2 class="text-xl text-center font-semibold mb-5">Informations générales</h2>
            <p class="text-gray-600 font-semibold">Date de la commande : <?= htmlspecialchars($order['order_date']) ?></p>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <h2 class="text-xl text-center font-semibold mb-4">Produits commandés</h2>
